    ...
    <div class="container">
    	<div class="row justify-content-between">
    		<div class="col-lg-6 col-md-6 col-sm-12 col-12 offset-lg-1 offset-md-1 headings">
    			<p class="headings-title">ORDERING<br><span>A TAXI</span></p>
    		</div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-12 left-content">
                ...
                <div class="taxi-block">
                    <div class="taxi-logo">
                        <img src="/storage/img/services/taxi-logo.png">
                 ...
                 <div class="taxi-block">
                    <div class="taxi-logo">
                        <img src="/storage/img/services/yandex.jfif">
                    </div>
                    <div class="taxi-content"> 
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-12 right-content">
                  <div class="taxi-block">
                    ...
                    <div class="taxi-content"> 
                      ...
                      <p class="taxi-info">The Allo Taxi is a quick and easy way of ordering a taxi. Cars are normally dispatched within 5-10 minutes and you can track their location on the map in real time.You can download application by pressing order button</p>
                      <a href="https://play.google.com/store/apps/details?id=com.uznewmax.mytaxi&hl=en" class="order-link">Order</a>
                    </div>
                </div>
                ...
                <div class="taxi-block">
                    ...
                    <div class="taxi-content"> 
                      <h5 class="taxi-title">Easy Taxi</h5>
                      <p class="taxi-info">The Easy Taxi is a quick and easy way of ordering a taxi. Cars are normally dispatched within 5-10 minutes and you can track their location on the map in real time.You can download application by pressing order button</p>
                      <a href="https://play.google.com/store/apps/details?id=com.uznewmax.mytaxi&hl=en" class="order-link">Order</a>
                    </div>
                </div>
