                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        ...
                        <div class="login-right">
                            ...
                            <form action="{{ route('register') }}" method="post">
                                ...
                                <input type="text" class="input{{$errors->has('email') ? 'is-invalid' : '' }}" placeholder="e-Mail or Login" name="email" value="{{ old('email') }}" required autofocus>
                                @if ($errors->has('email'))
                                    <span class="invalid-feedback">
                                ...
                                <input type="text" class="input{{$errors->has('name') ? 'is-invalid' : '' }}" placeholder="Name" name="name" value="{{ old('name') }}" required autofocus>
                                @if ($errors->has('name'))
                                    <span class="invalid-feedback">
                                        <strong>{{ $errors->first('name') }}</strong>
                                    </span>
                                ...
                                <input type="password" id="password" class="input{{ $errors->has('password') ? 'is-invalid' : '' }}" name="password" required placeholder="Password">
                                @if ($errors->has('password'))
                                <span class="invalid-feedback">
                                    <strong>{{ $errors->first('password') }}</strong>
                                </span>
                                ...
                                <input type="password" id="password-confirm" class="input" name="password_confirmation" placeholder="Confirm Password" required>
