...
$(window).scroll(function(){$(window).scrollTop()>=$(window).height()-50?($(".navbar-home").addClass("light-nav"),$(".navbar-home").removeClass("transparent-nav"),$(".img-logo").attr("src","img/logo_uzb_grey.svg")):($(".navbar-home").addClass("transparent-nav"),$(".navbar-home").removeClass("light-nav"),$(".img-logo").attr("src","img/logo_uzb.svg"))}),$(".discover").click(function(){$("html, body").animate({scrollTop:$(".home-second").position().top},1e3)}),$(".play").click(function(){$(".player").trigger("play"),$(".play").css("display","none"),$(".pause").css("display","block")}),$(".pause").click(function(){$(".player").trigger("pause"),$(".play").css("display","block"),$(".pause").css("display","none")}),$(function(){$(document).ready(function(){$(".owl-carousel").owlCarousel()})});var owl=$(".owl-one");owl.owlCarousel({loop:!0,margin:10,responsive:{0:{items:2},600:{items:3},960:{items:5},1200:{items:6}}}),owl.on("mousewheel",".owl-stage",function(e){e.deltaY>0?owl.trigger("next.owl"):owl.trigger("prev.owl"),e.preventDefault()}),$("#music").click(function(){$(".sub-content-text").text("Central Asian classical music is called Shashmaqam, which arose in Bukhara in the late 16th century when that city was a regional capital. Shashmaqam is closely related to Azerbaijani Mugam and Uyghur muqam. The name, which translates as six maqams refers to the structure of the music, which contains six sections in six different Musical modes, similar to classical Persian traditional music. Interludes of spoken Sufi poetry interrupt the music, typically beginning at a lower register and gradually ascending to a climax before calming back down to the beginning tone."),$(".ls").removeClass("active"),$(".ms").addClass("active"),$(".culture-link").attr("href","content.php?music")}),$("#education").click(function(){$(".sub-content-text").text("INFORMATION ABOUT EDUCATION"),$(".ls").removeClass("active"),$(".ed").addClass("active"),$(".culture-link").attr("href","content.php?education")}),$("#holidays").click(function(){$(".sub-content-text").text("INFORMATION ABOUT HOLIDAYS"),$(".ls").removeClass("active"),$(".hl").addClass("active"),$(".culture-link").attr("href","content.php?holidays")}),$("#cuisine").click(function(){$(".sub-content-text").text("INFORMATION ABOUT CUISINE"),$(".ls").removeClass("active"),$(".cs").addClass("active"),$(".culture-link").attr("href","content.php?cuisine")}),$("#sport").click(function(){$(".sub-content-text").text("INFORMATION ABOUT SPORT"),$(".ls").removeClass("active"),$(".sp").addClass("active"),$(".culture-link").attr("href","content.php?sport")});